...
res_1 <- read.csv(file="~/unam/2020-II/computo_evolutivo/tareas/tarea2/res_bin_4_1.csv")
res_2 <- read.csv(file="~/unam/2020-II/computo_evolutivo/tareas/tarea2/res_bin_4_2.csv")
res_3 <- read.csv(file="~/unam/2020-II/computo_evolutivo/tareas/tarea2/res_bin_4_3.csv")
res_4 <- read.csv(file="~/unam/2020-II/computo_evolutivo/tareas/tarea2/res_bin_4_4.csv")
res_5 <- read.csv(file="~/unam/2020-II/computo_evolutivo/tareas/tarea2/res_bin_4_5.csv")
res_6 <- read.csv(file="~/unam/2020-II/computo_evolutivo/tareas/tarea2/res_bin_4_6.csv")
res_7 <- read.csv(file="~/unam/2020-II/computo_evolutivo/tareas/tarea2/res_bin_4_7.csv")
res_8 <- read.csv(file="~/unam/2020-II/computo_evolutivo/tareas/tarea2/res_bin_4_8.csv")
res_9 <- read.csv(file="~/unam/2020-II/computo_evolutivo/tareas/tarea2/res_bin_4_9.csv")
res_10 <- read.csv(file="~/unam/2020-II/computo_evolutivo/tareas/tarea2/res_bin_4_10.csv")
